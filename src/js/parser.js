		                    ...
		                    if (match!==null) {
		                    	...
		                    	if (sol) {
		                    		if (['title','author','homepage','background_color','text_color','key_repeat_interval','realtime_interval','again_interval','flickscreen','zoomscreen','color_palette','youtube','mouse_left','mouse_right','mouse_drag','mouse_rdrag','mouse_up','mouse_rup'].indexOf(token)>=0) {
		                    			...
		                    			state.tokenIndex=1;
		                    			return 'METADATA';
		                    		} else if ( ['run_rules_on_level_start','norepeat_action','require_player_movement','debug','verbose_logging','throttle_movement','noundo','noaction','norestart','scanline','mouse_left','mouse_drag','mouse_right','mouse_rdrag','mouse_up','mouse_rup','nokeyboard','log_turn_time'].indexOf(token)>=0) {
		                    			state.metadata.push(token);
